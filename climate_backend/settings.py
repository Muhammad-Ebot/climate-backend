"""
Django settings for climate_backend project.
...
SECRET_KEY = 'django-insecure-_nl_8v594fv+^0tuqb^=fx^5-&g=r=_u@0(!2^oo%(6kx9r3fo'
...
WSGI_APPLICATION = 'climate_backend.wsgi.application'
